	...
	<div id="editDialog" style="padding: 20px">     
    	<form id="editForm">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>性别:</td>
	    			<td><select id="edit_sex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="sex" disabled="disabled"><option ${user.tsex == '男'? 'selected':''} value="男">男</option><option ${user.tsex == '女'? 'selected':''} value="女">女</option></select></td>
	    		</tr>
