	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'sname',title:'姓名',width:100,sortable: true}, 
	    	...
	    	buttons: [
				...
				},
				{
					...
					handler:function(){
						...
						$("#edit_ccredit").textbox('setValue', selectRow.ccredit);
					}
				}
			],
	...
	<div id="editDialog" style="padding: 10px"> 
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			<td>学号:</td>
	    			<td><input id="edit_sno" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sno" data-options="required:true, missingMessage:'请填写学号'"  readonly="readonly"/></td>
	    		</tr>
	    		<tr>
	    			<td>姓名:</td>
	    			<td><input id="edit_sname" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="sname" data-options="required:true, missingMessage:'请填写姓名'" readonly="readonly"/></td>
	    		</tr>
	    		<tr>
	    			<td>课程代码:</td>
	    			<td><input id="edit_cno" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="cno" readonly="readonly" /></td>
	    		</tr>
	    		<tr>
	    			<td>课程名:</td>
	    			<td><input id="edit_cname" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="cname" readonly="readonly" /></td>
	    		</tr>
	    		<tr>
	    			<td>学期:</td>
	    			<td><input id="edit_cdate" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="cdate"  readonly="readonly" /></td>
	    		</tr>
	    		<tr>
	    			<td>分数:</td>
	    			<td><input id="edit_score" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="score"/></td>
	    		</tr>
	    		<tr>
	    			<td>学分:</td>
	    			<td><input id="edit_ccredit" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="ccredit" readonly="readonly" /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
