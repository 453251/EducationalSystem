	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
		        ...
		        {field:'tposition',title:'职位',width:100},
	  ...
	  //导出按钮事件
	    $("#export").click(function(){
	    	var url = "AdminServlet?method=exportTeacherList";
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "AdminServlet?method=editTeacher",
	...
	<div id="addDialog" style="padding: 10px">
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>性别:</td>
	    			<td><select id="add_tsex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="tsex"><option value="男">男</option><option value="女">女</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>年龄:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>性别:</td>
	    			<td><select id="edit_tsex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="tsex"><option value="男">男</option><option value="女">女</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>年龄:</td>
