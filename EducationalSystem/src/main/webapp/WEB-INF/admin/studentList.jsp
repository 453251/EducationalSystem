	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
		        ...
		        {field:'syear',title:'入学年份',width:100,sortable: true},
 		        ...
 		        {field:'clno',title:'班级编号',width:100},
 		        {field:'clname',title:'班级',width:150},
 		        {field:'mno',title:'专业编号',width:100},
	  ...
	  //导出按钮事件
	    $("#export").click(function(){
	    	var url = "AdminServlet?method=exportStudentList";
	    	...
	    	buttons: [
				...
				},
				{
					...
					handler:function(){
						...
						$("#edit_ssex").textbox('setValue', selectRow.ssex);
	...
	<div id="addDialog" style="padding: 10px">
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>性别:</td>
	    			<td><select id="add_ssex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="ssex"><option value="男">男</option><option value="女">女</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>年龄:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>性别:</td>
	    			<td><select id="edit_ssex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="ssex"><option value="男">男</option><option value="女">女</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>年龄:</td>
