			...
			$.ajax({
				...
				success: function(msg){
					if("vcodeError" == msg){
						...
						window.location.href = "LoginServlet?method=AdminView";
					} else if("student" == msg){
						window.location.href = "LoginServlet?method=StudentView";
					} else if("teacher" == msg){
						window.location.href = "LoginServlet?method=TeacherView";
					}
				}
...
<title>登录|郑州大学教务系统</title>
<meta name="keywords" content="成绩管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;"><img src="zzuLogo.png" alt="Icon" style="vertical-align:middle; margin-right: 10px; width: 50px; height: 50px;" />郑州大学教务系统</h2>
</div>
  ...
  <div id="loginform" class="loginBox">
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="mt-20 skin-minimal" style="text-align: center;">
		<div class="radio-box">
			<input type="radio" id="radio-2" name="type" checked value="0" />
		...
		<div class="radio-box">
			<input type="radio" id="radio-1" name="type" value="2" />
...
<div class="footer">zzu.admin</div>
</body>
</html>