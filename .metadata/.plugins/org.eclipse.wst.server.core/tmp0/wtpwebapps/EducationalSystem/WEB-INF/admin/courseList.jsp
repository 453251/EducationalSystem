	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},		       
 		        ...
 		        {field:'chour',title:'学时',width:100},
 		        {field:'ccredit',title:'学分',width:50},  
		        {field:'cway',title:'考核方式',width:100},
 		        {field:'cdate',title:'学期',width:200},
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
	  ...
	  //导出按钮事件
	    $("#export").click(function(){
	    	var url = "AdminServlet?method=exportCourseList";
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										$("#add_chour").textbox('setValue', "");
										$("#add_credit").textbox('setValue', "");
										$("#add_cway").textbox('setValue', "");
										$("#add_cdate").textbox('setValue', "");
										//重新刷新页面数据
							  			$('#dataList').datagrid("reload");	
							  			$("#dataList").datagrid("uncheckAll");
									} else{
	    	...
	    	buttons: [
				...
				},
				{
					...
					handler:function(){
						...
						$("#edit_chour").textbox('setValue', selectRow.chour);
						$("#edit_credit").textbox('setValue', selectRow.ccredit);
						$("#edit_cway").textbox('setValue', selectRow.cway);
						$("#edit_cdate").textbox('setValue', selectRow.cdate);	
					}
				}
			],
	...
	<div id="addDialog" style="padding: 10px">
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>任课教师:</td>
	    			<td><input id="add_tname" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="tname" data-options="required:true, missingMessage:'请填写任课教师名'" /></td>
	    		</tr>
	    		<tr>
	    			<td>学时:</td>
	    			<td><input id="add_chour" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="chour" /></td>
	    		</tr>
	    		<tr>
	    			<td>学分:</td>
	    		...
	    		<tr>
	    			<td>考核形式:</td>
	    			<td><input id="add_cway" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="cway"/></td>
	    		</tr>  
	    		<tr>
	    			<td>学期:</td>
	    			<td><input id="add_cdate" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="cdate"/></td>
	    		</tr>    
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			<td>课程代码:</td>
	    			<td><input id="edit_cno" class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="cno" readonly="readonly" data-options="required:true,missingMessage:'请输入课程代码'" /></td>
	    		</tr>
	    		<tr>
	    			<td>课程名:</td>
	    		...
	    		<tr>
	    			<td>任课教师:</td>
	    			<td><input id="edit_tname" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="tname" data-options="required:true, missingMessage:'请填写任课教师名'" /></td>
	    		</tr>
	    		<tr>
	    			<td>学时:</td>
	    			<td><input id="edit_chour" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="chour" /></td>
	    		</tr>
	    		<tr>
	    			<td>学分:</td>
	    		...
	    		<tr>
	    			<td>考核形式:</td>
	    			<td><input id="edit_cway" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="cway"/></td>
	    		</tr>  
	    		<tr>
	    			<td>学期:</td>
	    			<td><input id="edit_cdate" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="cdate"/></td>
	    		</tr>    
	    	</table>
	    </form>
	</div>	
